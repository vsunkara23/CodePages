...
Features include full-text search of wiki pages, creating new pages, support for Markdown and HTML editing, a graphical diff viewer for successive edits, a live preview that renders the applied markdown and html formatting on text in real-time, and code highlighting that supports over 189 languages.   
